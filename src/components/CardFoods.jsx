...
function CardFoods({ setItem }) {
  ...
  return (
    ...
    <div className="cardContainer">
      <Cart cart={cart} shoppingCart={shoppingCart} removeCart={removeCart} calculateTotal={calculateTotal}/>
      <div className="cart">
      <button className="cartBtn"onClick={changeClass}><i className='bx bx-cart-alt'></i></button>
      </div>
        ...
        {currentItems.map((food) => (
          <div key={food.id} className="foodCardContainer">
            ...
            <div className="info-food">
              ...
              <button className="foodsBuyBtn" onClick={() => addCart(food)} >Comprar</button>
            </div>
          </div>
        ))}
      </div>
